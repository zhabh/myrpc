#ifndef _CRUCIS_GENERATOR_ID_H_
#define _CRUCIS_GENERATOR_ID_H_
...
#define COMM_SEQUENCE_BEGIN 1000000
#define PLAYER_SEQUENCE_BEGIN 2000000
#define COPYMAP_SEQUENCE_BEGIN 3000000
	...
	*/
	...
	public:
		...
		{
			static SnowflakeIdWorker id_worker_;
			return id_worker_;
		}
	...
	protected:
		...
		SnowflakeIdWorker(const SnowflakeIdWorker&) = delete;
		SnowflakeIdWorker& operator=(const SnowflakeIdWorker&) = delete;
	...
	private:
		...
		* 机器id所占的位数
		*/
		const UInt workerIdBits = 7;

		/**
		* 数据中心id所占的位数
		*/
		const UInt datacenterIdBits = 7;

		/**
		* 序列所占的位数
		*/
		const UInt sequenceBits = 8;

		/**
		* 时间戳所占的位数
		*/
		const UInt timestampBits = 41;
	...
	typedef SnowflakeIdWorker sequence_id_t;
}


#endif // _CRUCIS_GENERATOR_ID_H_