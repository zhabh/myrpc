...
#ifndef PROTOBUF_user_5ftype_2eproto__INCLUDED
#define PROTOBUF_user_5ftype_2eproto__INCLUDED
...
namespace protobuf_user_5ftype_2eproto {
...
const UserType UserType_MIN = user_type_unknow;
const UserType UserType_MAX = user_type_monster;
...
template <> struct is_proto_enum< ::crucis::UserType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::crucis::UserType>() {
  return ::crucis::UserType_descriptor();
}
...
#endif  // PROTOBUF_user_5ftype_2eproto__INCLUDED
